    ...
    <div className="p-14">
      <div className="text-center py-4">
        ...
        <p className="py-4">
          ...
          propose une variété de plats traditionnels préparés avec des recettes
          transmises de génération en génération et des ingrédients frais.
        </p>
      </div>
      <div className="text-center py-4">
        ...
        <p className="py-4">
          ...
          plats délicieux et authentiques. Parmi nos ingrédients phares, citons
          le riz thaïlandais, les nouilles de riz, les crevettes, le poulet, le
          porc, les légumes frais tels que les carottes, les poivrons et les
          champignons, ainsi que des épices et des sauces authentiques telles
          que le curry rouge, le curry vert et le nuoc mam.
        </p>
      </div>
      <div className="text-center py-4">
        ...
        <p className="py-4">
          ...
          attention aux détails. Notre équipe de chefs expérimentés maîtrise les
          techniques traditionnelles de cuisson et de préparation, ce qui se
          reflète dans chaque bouchée que vous dégusterez. Profitez de nos
